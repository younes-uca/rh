...
public class ReclamationCriteria extends  BaseCriteria  {
    ...
    private EmployeCriteria destinataire ;
    private List<EmployeCriteria> destinataires ;
    ...
    public EmployeCriteria getDestinataire(){
        return this.destinataire;
    }

    public void setDestinataire(EmployeCriteria destinataire){
        this.destinataire = destinataire;
    }
    public List<EmployeCriteria> getDestinataires(){
        return this.destinataires;
    }

    public void setDestinataires(List<EmployeCriteria> destinataires){
