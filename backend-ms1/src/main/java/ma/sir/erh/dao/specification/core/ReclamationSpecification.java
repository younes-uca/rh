...
public class ReclamationSpecification extends  AbstractSpecification<ReclamationCriteria, Reclamation>  {
    ...
    public void constructPredicates() {
        ...
        addPredicateFk("destinataire","id", criteria.getDestinataire()==null?null:criteria.getDestinataire().getId());
        addPredicateFk("destinataire","id", criteria.getDestinataires());
    }
