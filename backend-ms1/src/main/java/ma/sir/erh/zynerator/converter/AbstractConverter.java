package ma.sir.erh.zynerator.converter;


import ma.sir.erh.zynerator.bean.Etablissement;
import ma.sir.erh.zynerator.dto.EtablissementDto;

import ma.sir.erh.zynerator.util.ListUtil;
import ma.sir.erh.zynerator.audit.AuditBusinessObject;
import ma.sir.erh.zynerator.bean.BusinessObject;
import ma.sir.erh.zynerator.dto.AuditBaseDto;
import ma.sir.erh.zynerator.dto.BaseDto;
import ma.sir.erh.zynerator.util.DateUtil;
import ma.sir.erh.zynerator.util.RefelexivityUtil;
import ma.sir.erh.zynerator.util.StringUtil;
import ma.sir.erh.zynerator.util.Utils;
