...
import ma.sir.erh.ws.converter.DemandeCongeConverter;
...
public class DemandeCongeRestAdmin  extends AbstractController<DemandeConge, DemandeCongeDto, DemandeCongeHistory, DemandeCongeCriteria, DemandeCongeHistoryCriteria, DemandeCongeAdminService, DemandeCongeConverter> {
    ...
    @ApiOperation("find by chefRH id")
    @GetMapping("chefRH/id/{id}")
    public List<DemandeConge> findByChefRHId(@PathVariable Long id){
        return service.findByChefRHId(id);
    }
    @ApiOperation("delete by chefRH id")
    @DeleteMapping("chefRH/id/{id}")
    public int deleteByChefRHId(@PathVariable Long id){
        return service.deleteByChefRHId(id);
    }
    @ApiOperation("find by chedDepartement id")
    @GetMapping("chedDepartement/id/{id}")
    public List<DemandeConge> findByChedDepartementId(@PathVariable Long id){
        return service.findByChedDepartementId(id);
    }
    @ApiOperation("delete by chedDepartement id")
    @DeleteMapping("chedDepartement/id/{id}")
    public int deleteByChedDepartementId(@PathVariable Long id){
        return service.deleteByChedDepartementId(id);
    }
