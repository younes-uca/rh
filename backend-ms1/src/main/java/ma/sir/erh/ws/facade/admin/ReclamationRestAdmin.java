...
import ma.sir.erh.ws.converter.ReclamationConverter;
import ma.sir.erh.ws.dto.ReclamationDto;
...
public class ReclamationRestAdmin  extends AbstractController<Reclamation, ReclamationDto, ReclamationHistory, ReclamationCriteria, ReclamationHistoryCriteria, ReclamationAdminService, ReclamationConverter> {
    ...
    @ApiOperation("find by destinataire id")
    @GetMapping("destinataire/id/{id}")
    public List<Reclamation> findByDestinataireId(@PathVariable Long id){
        return service.findByDestinataireId(id);
    }
    @ApiOperation("delete by destinataire id")
    @DeleteMapping("destinataire/id/{id}")
    public int deleteByDestinataireId(@PathVariable Long id){
        return service.deleteByDestinataireId(id);
    }
