...
public class DemandeConge   extends AuditBusinessObject     {
    ...
    private Employe chefRH ;
    
    private Employe chedDepartement ;
    ...
    public Employe getChefRH(){
        return this.chefRH;
    }
    public void setChefRH(Employe chefRH){
        this.chefRH = chefRH;
    }
    @ManyToOne(fetch = FetchType.LAZY)
    public Employe getChedDepartement(){
        return this.chedDepartement;
    }
    public void setChedDepartement(Employe chedDepartement){
