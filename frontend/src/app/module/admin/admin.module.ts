...
import { MessagerieAdminModule } from './view/Messagerie/Messagerie-admin.module';
import { MessagerieAdminRoutingModule } from './view/Messagerie/Messagerie-admin-routing.module';
...
@NgModule({
  ...
  MessagerieAdminModule,
  MessagerieAdminRoutingModule,
