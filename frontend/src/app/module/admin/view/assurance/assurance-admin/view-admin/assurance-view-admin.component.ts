...
export class AssuranceViewAdminComponent extends AbstractViewController<AssuranceDto, AssuranceCriteria, AssuranceService> implements OnInit {
    ...
    constructor(private assuranceService: AssuranceService, private lienParenteService: LienParenteService, private compagnieAssuranceService: CompagnieAssuranceService, private societeService: SocieteService, private employeService: EmployeService){
