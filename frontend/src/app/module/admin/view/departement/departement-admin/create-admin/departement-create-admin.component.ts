...
export class DepartementCreateAdminComponent extends AbstractCreateController<DepartementDto, DepartementCriteria, DepartementService>  implements OnInit {
    ...
    constructor( private departementService: DepartementService , private stationService: StationService, private siegeService: SiegeService, private employeService: EmployeService) {
