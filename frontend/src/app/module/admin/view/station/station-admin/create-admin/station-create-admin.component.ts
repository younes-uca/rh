...
export class StationCreateAdminComponent extends AbstractCreateController<StationDto, StationCriteria, StationService>  implements OnInit {
    ...
    constructor( private stationService: StationService , private villeService: VilleService, private departementService: DepartementService, private employeService: EmployeService, private siegeService: SiegeService) {
